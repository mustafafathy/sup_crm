...
//custom
$route['admin/reports/campaign_report/export'] = 'admin/Report_Export/export_campaign_report';
$route['admin/reports/agent_report/export'] = 'admin/Report_Export/export_agent_report';
$route['admin/reports/missing_report/export'] = 'admin/Report_Export/export_missing_report';
$route['notifications/data'] = 'notifications/data';
...
$route['admin/task/add'] = 'admin/task/add';
$route['admin/task/edit/(:num)'] = 'admin/task/edit/$1';
$route['admin/task/delete/(:num)'] = 'admin/task/delete/$1';  
/**
