...
$lang['leads_canban_source']               = 'Campaign: %s';
$lang['lead_new_source']                   = 'New Campaign';
$lang['lead_sources']                      = 'Lead Campaign';
$lang['lead_source']                       = 'Campaign';
$lang['lead_source_lowercase']             = 'lead Campaign';
$lang['leads_sources_not_found']           = 'No leads Campaign found';
$lang['leads_sources_table_name']          = 'Campaign Name';
$lang['leads_source_add_edit_name']        = 'Campaign Name';
...
$lang['acs_leads_sources_submenu']             = 'Campaign';
...
# Settings
$lang['settings_allow_payment_amount_to_be_modified'] = 'Allow client to modify the amount to pay (for online payments)';
...
$lang['settings_exclude_estimate_from_client_area_with_draft_status'] = 'Exclude estimates with draft status from clients area';
...
$lang['expense_recurring_send_custom_on_renew']       = 'Send the invoice to client email when expense re-created';
$lang['expense_recurring_autocreate_invoice_tooltip'] = 'If this option is checked the invoice for the client will be auto created when the expense will be renewed.';
...
# Contacts
$lang['contract_not_visible_to_client'] = 'Hide from client';
...
# Leads
$lang['copy_custom_fields_convert_to_customer']                      = 'Copy custom fields to client profile';
$lang['copy_custom_fields_convert_to_customer_help']                 = 'If any of the following custom fields do not exists for client will be auto created with the same name otherwise only the value will be copied from the lead profile.';
...
$lang['leads_email_integration_default_source']                      = 'Default Campaign';
...
$lang['lead_import_source']          = 'Campaign';
...
$lang['set_reminder_tooltip']    = 'This option allows you to never forget anything about your clients.';
...
$lang['proposal_convert_to_lead_disabled_help'] = 'You need to convert the lead to client in order to create %s';
$lang['proposal_convert_not_related_help']      = 'The proposal needs to be related to client in order to convert to %s';
...
$lang['not_lead_activity_converted_email']                        = 'Lead email changed. First lead email was: %s and added as client with email %s';
$lang['not_lead_activity_converted']                              = '%s Converted this lead to client';
...
$lang['not_proposal_comment_from_client']                         = 'New comment from client on proposal %s ...';
...
$lang['estimate_activity_client_accepted_and_converted']          = 'Client accepted this estimate. Estimate is converted to invoice with number %s';
...
$lang['invoice_activity_sent_to_client_cron']                     = 'Invoice sent to client by CRON';
$lang['invoice_activity_sent_to_client']                          = 'sent invoice to client';
...
$lang['settings_client_staff_add_edit_delete_task_comments_first_hour'] = 'Allow client/staff to add/edit task comments only in the first hour (administrators not applied)';
...
$lang['task_visible_to_client'] = 'Visible to client';
...
$lang['project_view_as_client']                              = 'View project as client';
...
$lang['project_allow_client_to']                             = 'Allow client to %s';
...
$lang['project_activity_visible_to_customer']          = 'Visible to client';
...
$lang['no_primary_contact']                      = 'This client does have primary contact. You need to setup primary contact login as client. Its recommended all clients to have primary contacts.';
...
$lang['contract_sent_to_client_success']          = 'The contract is successfully sent to the client';
...
$lang['total_clients_deleted']                            = 'Total clients deleted: %s';
...
$lang['notification_when_customer_pay_invoice'] = 'Receive notification when client pay invoice (built-in)';
...
$lang['allow_customer_to_change_ticket_status'] = 'Allow client to change ticket status from clients area';
...
$lang['lead_lock_after_convert_to_customer']    = 'Do not allow leads to be edited after they are converted to clients (administrators not applied)';
...
$lang['customer_admin_login_as_client_message'] = 'Hello %s. You are added as admin to this client.';
...
# Version 1.1.9
$lang['use_recaptcha_customers_area']    = 'Enable reCAPTCHA on clients area (Login/Register)';
...
$lang['swap_pdf_info']                            = 'Swap Company/Client Details (company details to right side, client details to left side)';
...
$lang['show_to_customer']                         = 'Show to client';
$lang['hide_from_customer']                       = 'Hide from client';
...
$lang['description_visible_to_customer']        = 'Show description to client';
...
$lang['custom_field_disallow_customer_to_edit'] = 'Disallow client to edit this field';
...
$lang['do_not_send_invoice_payment_email_template_contact'] = 'Do not send invoice payment recorded email to client contacts';
...
$lang['only_show_contact_tickets']                          = 'In clients area only show tickets related to the logged in contact (Primary contact not applied)';
$lang['cancel_overdue_reminders_invoice']                   = 'Prevent sending overdue reminders for this invoice';
$lang['customer_shipping_address_notice']                   = 'Do not fill shipping address information if you won\'t use shipping address on client invoices';
...
$lang['exclude_invoices_draft_from_client_area']            = 'Exclude invoices with draft status from clients area';
$lang['invoice_draft_status_info']                          = 'This invoice is with status Draft, status will be auto changed when you send the invoice to the client or mark as sent.';
...
$lang['customer_currency_change_notice']           = 'If the client use other currency then the base currency make sure you select the appropriate currency for this client. Changing the currency is not possible after transactions are recorded.';
...
$lang['sending_email_contact_permissions_warning'] = 'Failed to auto select client contacts. Please make sure that the client have associated contacts with permission %s';
...
$lang['leads_report_converted_notice']                        = 'Only leads that belongs in the default Client status will be taken as converted leads, if the leads belongs to the default status client and its not converted to client will be still counted as converted lead';
...
$lang['auto_assign_customer_admin_after_lead_convert']      = 'Auto assign as admin to client after convert';
$lang['auto_assign_customer_admin_after_lead_convert_help'] = 'If this option is set to YES the staff member that converted lead to client will be auto assigned as client admin. NOTE: This option will apply only on staff members that do not have permission for clients VIEW';
...
$lang['bulk_action_customers_groups_warning']        = 'If you do not select any group all groups assigned to the selected clients will be removed.';
$lang['customer_attachments_show_in_customers_area'] = 'Show to clients area';
$lang['customer_attachments_show_notice']            = 'Only files uploaded from client profile have ability to show/hide in clients area.';
...
$lang['customer_inactive_message']               = 'This is inactive client profile and some features may be disabled';
...
$lang['permission_customers_based_on_admins']               = 'Based on client admins';
...
$lang['file']                                               = 'File';
$lang['customer_contact_person_only_one_allowed']           = 'Only 1 contact is allowed when the company field is not filled. The system will cast this client as person';
...
$lang['only_own_files_contacts']                                 = 'Contacts see only own files uploaded in client area (files uploaded in client profile)';
$lang['only_own_files_contacts_help']                            = 'If you share the file manually from client profile to other contacts they wil be able to see the file.';
...
$lang['staff_members_open_tickets_to_all_contacts_help'] = 'If staff member don\'t have permission for clients VIEW only will be able to create new tickets from admin area to client contacts where is assigned as client admin.';
...
$lang['no_vault_entries']                         = 'Vault entries not found for this client.';
$lang['vault_entry_created_from']                 = 'This vault entry is created by %s';
$lang['vault_entry_last_update']                  = 'Last updated by %s';
$lang['vault_entry_visible_to_all']               = 'Visible to all staff member who have access to this client';
...
$lang['custom_field_pdf_html_help']                        = 'Make sure you check ' . $lang['custom_field_show_on_client_portal'] . ' field if you want the custom fields to be visible to clients area and when client download PDF or receive PDF via email.';
$lang['auto']                                              = 'Auto';
...
$lang['reccuring_invoice_option_gen_and_send']             = 'Generate and autosend the renewed invoice to the client';
...
$lang['credit_note_no_invoices_available']                       = 'There are no available invoices for this client.';
...
$lang['lead_is_contact_create_task']              = 'Create task if email sender is already client and assign to responsible staff member.';
$lang['existing_customer']                        = 'Existing Client';
$lang['use_company_name_instead']                 = 'Use company name instead';
$lang['customer_delete_transactions_warning']     = 'This client has transactions, %s, you must delete the transactions or move to another client in order to perform this action.';

# Version 1.9.8
$lang['sending_email_contact_permissions_warning'] = 'Failed to auto select client contacts. Make sure that the client has active contacts and associated contacts with email notifications for %s enabled.';
...
$lang['ideal_customer_statement_descriptor']       = 'Statement Descriptor (shown in client bank statement)';
...
$lang['not_viewed_yet']                                         = 'This %s is not viewed yet by the client';
$lang['undo']                                                   = 'Undo';
...
$lang['not_contract_comment_from_client']                       = 'New comment from client on contract %s ...';
...
$lang['show_subscriptions_in_customers_area']                   = 'Show subscriptions in clients area?';
$lang['show_subscriptions_in_customers_area_help']              = 'This option is valid only for the client primary contact.';
...
$lang['view']                                                   = 'View';
$lang['customer_is_subscribed_to_subscription_info']            = 'The client is subscribed to this subscription';
...
$lang['customers_register_require_confirmation']                = 'Require registration confirmation from administrator after client register';
...
$lang['not_contract_signed']                            = 'Contract with subject %s has been signed by the client';
$lang['the_number_sign']                                = '#';
$lang['not_new_ticket_reply']                           = 'Client replied to ticket - %s';
$lang['receive_notification_on_new_ticket_replies']     = 'Receive notification when client reply to a ticket';
$lang['receive_notification_on_new_ticket_reply_help']  = 'All staff members which belong to the ticket department will receive notification when client reply to a ticket';
...
$lang['company_exists_info']                                         = 'It looks that a client with name %s already exists, if you still want to create the client you can ignore this message.';
...
# Version 2.2.1
$lang['customer_files_info_message'] = 'Files from projects and tasks linked to the client are not shown on this table.';
...
$lang['subscriptions_terms_info']                  = 'Enter client terms & conditions to be displayed to the client before subscribe to the subscription.';
...
$lang['subscription_first_billing_date_info']      = 'Leave blank to use date when the client is subscribed to the subscription. This field must be future date, if you select date and the date is passed but client is not yet subscribed, the date when the client will subscribe will be used.';
...
$lang['allow_primary_contact_to_manage_other_contacts']       = 'Allow primary contact to manage other client contacts';
$lang['contact_form_validation_is_unique']                    = 'Contact with this {field} already exists in our system';
$lang['invoice_number_not_applied_on_draft']                  = 'If the invoice is saved as draft, the number won\'t be applied, instead, the next invoice number will be given when the invoice is sent to the client or is marked as sent.';
...
$lang['estimate_request_client_created_success']           = 'Estimate Request Client Created';
...
$lang['due_reminders_for_invoices_info'] = 'Due reminders are sent to unpaid and partially paid invoices as reminder to the client to pay the invoice before is due.';
...
$lang['show_estimate_request_in_customers_area']              = 'Show Estimate request link in clients area?';
...
$lang['hide_milestone_from_customer']              = 'Hide from client';
$lang['hide_milestone_from_customer_help']         = 'When you decide to hide milestone from the client area, the whole milestone and its tasks will be hidden';
...
$lang['batch_payment_filter_by_customer']                 = 'Filter invoices by client';
$lang['batch_payments']                                   = 'Batch Payments';
$lang['batch_payment_added_successfully']                 = 'You have successfully added %s payments';
$lang['batch_payments_send_invoice_payment_recorded']     = 'Do not send invoice payment recorded email to client contacts';
...
$lang['settings_contract_sign_reminder_every_days_info']    = 'Sign reminders are sent to the client contacts after the contract is first time sent to the client and they are automatically stopped when the contract is signed.';
...
$lang['required_register_fields'] = 'Required fields for registration (clients area)';
