            ...
            item.addEventListener('click', function() {
                ...
                if (submenu) {
                    ...
                    if (submenu.classList.contains('collapse')) {
                        submenu.classList.remove('collapse'); // Remove collapse
                        submenu.classList.add('show');        // Add show
                    } else {
                        submenu.classList.remove('show');     // Remove show
                        submenu.classList.add('collapse');    // Add collapse
                    }
                }
            });
        });
