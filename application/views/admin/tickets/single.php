...
<div id="wrapper">
    <div class="content">
                    ...
                    <div class="panel-body">
                        ...
                        ?>
                                    ...
                                    <div class="ticket-reply-tools">
                                        <?php if ($ticket->merged_ticket_id === null) { ?>
                                        <div class="btn-bottom-toolbar text-right" style="block-size: auto;width: 100%;display: unset;">
        ...
        <a href="#top" id="toplink" style="position: fixed;display: flex;justify-content: center; font-family: auto; text-anchor: middle;width: 10px; right: 3%; top: 45%;">↑</a>
        <a href="#bot" style="position: fixed;display: flex;justify-content: center; font-family: auto; text-anchor: middle;width: 10px; right: 3%; bottom: 45%;" id="botlink">↓</a>
        <?php } ?>
    </div>
</div>
<!-- The reminders modal -->
