...
$is_admin = is_admin();
$i        = 0;
$category = $this->session->userdata('account_category') ?? 'defaultCategory'; // Fallback to session or default

$this->category = $category;

foreach ($statuses as $status) {
    $kanBan = new \app\services\leads\LeadsKanban($status['id'],$category);
